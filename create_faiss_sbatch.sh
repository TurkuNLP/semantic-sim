...
python3 create_faiss_index.py --prepare-sample $DATADIR/faiss_index_train_sample_${model}.pt $DATADIR/embedded_batches_${model}/all_uniq_data_0_30.pkl #this is every 30th sentence in all of the data
